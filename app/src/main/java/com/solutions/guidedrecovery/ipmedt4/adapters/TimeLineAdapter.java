...
import com.solutions.guidedrecovery.ipmedt4.activities.FysioActivity;
import com.solutions.guidedrecovery.ipmedt4.activities.GipsActivity;
import com.solutions.guidedrecovery.ipmedt4.R;
import com.solutions.guidedrecovery.ipmedt4.activities.VervolgAfspraakActivity;
            ...
            public void onClick(View v) {
                ...
                switch (pos){
                    case 0:
                        ...
                        break;
                    case 1:
                        intent =  new Intent(viewHolder.context2, VervolgAfspraakActivity.class);
                        break;
                    case 2:
                        intent =  new Intent(viewHolder.context2, VervolgAfspraakActivity.class);
                        break;
                    case 3:
                        ...
                        break;
                    case 4:
                        intent =  new Intent(viewHolder.context2, FysioActivity.class);
                        break;
                    default:
                        intent =  new Intent(viewHolder.context2, GipsActivity.class);
                        break;
                                ...
                                for(progressStatus = progressStatus; progressStatus < Math.round(percent); progressStatus++)
                                {
                                    handler.post(new Runnable()
                                    {
                                        ...
                                        public void run()
                                        {
                                            ...
                                            viewHolder.cv.setBackgroundColor(Color.parseColor("#95e04f5f"));
